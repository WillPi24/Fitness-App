...
10. `security/N1-N3-polish` (bundle the low-severity items)

M5 (verify `__DEV__` strip) and M6 (App Review notes) are not PRs — they're verification + Apple Connect updates.
